...
public class CoreStateMgr : MonoBehaviourContainerBase
{
	...
	public virtual void GotoWorldRift()
	{
		SceneLoadingMgr.LoadGameScene("WorldRift", new List<string>());
	}
	...
	public virtual void GotoDimension1()
	{
		SceneLoadingMgr.LoadGameScene("Dimension1", new List<string>());
	}

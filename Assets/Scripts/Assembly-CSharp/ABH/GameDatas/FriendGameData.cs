...
namespace ABH.GameDatas
{
	public class FriendGameData
	{
		...
		private string GetNPCFriendName(string friendId)
		{
			...
			case "NPC_Asia":
				return DIContainerInfrastructure.GetLocaService().Tr("npc_friend_asia");
			case "NPC_Mauvey":
				return DIContainerInfrastructure.GetLocaService().Tr("npc_friend_mauvey");
			case "NPC_Rex":
				return DIContainerInfrastructure.GetLocaService().Tr("npc_friend_rex");
			case "NPC_Mace":
				return DIContainerInfrastructure.GetLocaService().Tr("npc_friend_mace");
			case "NPC_Adventurer":

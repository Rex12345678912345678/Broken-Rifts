	...
	public class SocialEnvironmentGameData : GameDataBase<SocialEnvironmentBalancingData, SocialEnvironmentData>
	{
		...
		private void InitGameData(SocialEnvironmentData instance)
		{
			...
			if (instance.AcceptedFriendIds != null)
			{
				...
				foreach (var acceptedFriendId in FriendIds)
				{
					var value = 0u;
				...
				instance.PublicPlayerInstances = new List<PublicPlayerData>
				{
					...
					DIContainerLogic.SocialService.GetNPCPlayer(DIContainerLogic.SocialService.GetAsiaFriend(1)),
					DIContainerLogic.SocialService.GetNPCPlayer(DIContainerLogic.SocialService.GetMauveyFriend(1)),
					DIContainerLogic.SocialService.GetNPCPlayer(DIContainerLogic.SocialService.GetRexFriend(1)),
					DIContainerLogic.SocialService.GetNPCPlayer(DIContainerLogic.SocialService.GetMaceFriend(1)),
		...
		public static void FillSocialEnvironmentDataIfEmpty(SocialEnvironmentData envData)
		{
			...
			envData.GetBirdCooldowns = new Dictionary<string, uint>
			{
				...
				{
					DIContainerLogic.SocialService.GetAsiaFriend(1).Id,
					0u
				},
				{
					DIContainerLogic.SocialService.GetMauveyFriend(1).Id,
					0u
				},
				{
					DIContainerLogic.SocialService.GetRexFriend(1).Id,
					0u
				},
				{
					DIContainerLogic.SocialService.GetMaceFriend(1).Id,
					0u
				},
				{
